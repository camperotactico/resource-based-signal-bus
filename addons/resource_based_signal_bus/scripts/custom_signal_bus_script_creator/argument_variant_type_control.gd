...
signal variant_type_changed(variant_type: Variant.Type)
signal variant_type_details_changed(variant_type_details: String)
...
func _on_variant_type_option_button_item_selected(new_selection_index: int) -> void:
	...
	variant_type_changed.emit(_current_variant_type)
